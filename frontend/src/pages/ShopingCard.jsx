...
const ShopingCard = () => {
  return (
    <div>
        <div className='flex flex-col lg:flex-row gap-5 px-36 py-10'>
           {/*----------Shoping Card----------*/}
           <div className='flex flex-col rounded border-2 border-gray-300 w-full  lg:w-3/5'>
            <p className='text-xl px-5 font-medium my-2'>Shoping Card</p>
            <div className='flex border-2 px-5 py-2 bg-gray-400 justify-between gap-1'>
           ...
           <div className='flex flex-col w-full lg:w-2/6'>
            ...
            <div className='flex flex-col rounded border-2 border-gray-300 w-full'>
                ...
                <div className='flex mb-5 px-5 justify-between'>
                        ...
                        <p className='justify-between font-semibold gap-10'>$357.99 <span>USD</span></p>
                </div>
                <button className='flex items-center gap-3 px-5 border bg-btnColor h-12 justify-center mx-4 mb-5 text-white font-medium rounded hover:scale-105 duration-500 transition-all'>PROCEED TO CHECKOUT <FaArrowRight /> </button>
            </div>
            {/*--------Second Div----------*/}
            <div className='flex flex-col rounded border-2 border-gray-300 w-full px-5 py-3 mt-5'>
                <p className='text-base font-medium my-5 text-gray-800 border-b'>Coupon Code</p>
                <div>
                    <input className='h-10 border border-blue-300 rounded px-5 w-full' type="email" placeholder='Email address'/>
                    <button className='my-3 border px-4 py-2 text-white bg-blueButton rounded hover:scale-105 duration-300 transition-all'>APPLY COUPON</button>
                </div>
            </div>
           </div>
        </div>
